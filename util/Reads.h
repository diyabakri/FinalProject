...
/*
    ...
    @params char* str expected format "path ="<URL>""
...
/*
    ...
    @params FILE fd file expected to be opend with fopen with read access
...
/*
    ...
    @params FILE fd file expected to be opend with fopen with read access , int* n = number of lines to read -1 => all lines 

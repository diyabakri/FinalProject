...
/**
 * @brief Calculates phi dot with relativty incorporated  "anugular speed" of and electron
 * 
 ...
 * @return double 
 */
double calc_rel_gamma(double l , double mass , double r, double r_dot);
/**
 * @brief Calculates R_dot_dot  with relativty incorporated "acceleration" of and electron
 * 
 ...
 * @return long double 
 */
long double calc_rel_w(long double energy_level ,long double K ,long double mass ,long double alpha );
/**

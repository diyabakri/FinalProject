...
def main():
    ...
    itrs , file_num , sub_files ,result_path = getInitVals()
    print(sub_files)
    ...
    for i in range(1,file_num+1): 
        ...
        for j in range(i):
            if j+1 not in sub_files and sub_files.all()!= 0:
                continue
